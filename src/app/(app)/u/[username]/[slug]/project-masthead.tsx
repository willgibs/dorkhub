...
export function ProjectMasthead({
  ...
  return (
    <header className={cn('relative isolate border-b', className)}>
      {/* Halftone atmosphere, masked toward the headline — the same opening
          treatment the home hero uses, so a project page reads as a place on
          dorkhub rather than a document viewer. */}
      <div
        aria-hidden="true"
