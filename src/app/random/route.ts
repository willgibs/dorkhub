 ...
 * to one random published project. Lives at /random since U2 R2.5 (board:
 * "random" is conceptually clearer than "weird" as a nav name); /weird
 * 308s here so shipped links keep working.
 *
