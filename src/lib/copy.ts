...
export const copy = {
  ...
  // W4: the directory says what it is showing and what it isn't. 24k tags
  // exist; listing them all is a wall, and pretending otherwise is worse.
  tagsKicker: 'the taxonomy',
  tagsNote: 'the corners of github we keep an eye on — pick one and start digging',
  tagsCuratedKicker: 'curated',
  tagsCuratedTitle: 'the shelves we keep',
  tagsPopularKicker: 'most used',
  tagsPopularTitle: 'what people are tagging',
  tagsPopularNote: 'every tag with a real pile of projects behind it',
  tagsUnitInUse: 'tags in use',
  tagsTailLead: 'showing the most-used of',
  tagsTailMid: 'tags — the long tail is reachable from any project page, or by',
  tagsTailLink: 'searching for it',
