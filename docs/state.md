...
- P3-C SCALE ✅ (docs/plans/p3c-scale.md, migrations 0013–0016, D31–D38):
  ...
  **Tag p3c awaits Will's green light. p3b also untagged.**

## Next (not started)
Design/motion QA sweep · P4 launch round (featured slots, fixture purge,
is_admin column-restrict, Vercel Pro cron swap, robots flip, sitemap+JSON-LD).
...
exercises the pipeline's 'budget' stopKind live.
...
Last updated: 2026-07-30 (P3-C shipped).
